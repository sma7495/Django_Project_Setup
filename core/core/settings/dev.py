...
# SECRET_KEY = "django-insecure-r)y#pg2rzo0^o7ljv_v&lw9lcrdgd%abukz%i)4e*4j9lf$x*$"
SECRET_KEY = config('SECRET_KEY', default= "django-insecure-r)y#pg2rzo0^o7ljv_v&lw9lcrdgd%abukz%i)4e*4j9lf$x*$")
